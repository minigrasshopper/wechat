 ...
 */
function canvas_img(imgSrc, parentId, elementId, cb) {
    var touchNum = 0;
    var canvas = document.getElementById(elementId), ctx = canvas.getContext("2d");
    var x1, y1, a = 30, timeout, totimes = 100, distance = 30;
    var saveDot = [];
    var canvasBox = document.getElementById(parentId);
