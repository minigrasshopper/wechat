var config = (function () {
    ...
    var baseUrl = isDebug ? '' : 'http://q.letwx.com/app/queencome-build/';
    var htmlUrl = isDebug ? '' : 'http://q.letwx.com/app/queencome-build/';
    var cdnUrl = isDebug ? '' : 'http://qcdn.letwx.com/app/queencome-build/';
    gameid = getUrlParam().uid != undefined ? getUrlParam().uid : 1;
    gp = getUrlParam().gp != undefined ? getUrlParam().gp : 'cgPVeQ1_Ey303fP2N3WiKE_kvbA25ca65u74bgGIxkI';
    return {
        gameid: gameid,
        uid: gameid,
        gp: gp,
...
function __uri(str) {
    return (config.baseCDNUrl + 'queencome-build/../' + str);
}
