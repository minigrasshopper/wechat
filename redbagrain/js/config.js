var config = (function() {
	...
	var baseUrl = isDebug ? '' :'http://q.letwx.com/app/redbagrain-build/';
	var htmlUrl = isDebug ? '' :'http://q.letwx.com/app/redbagrain-build/';
	var cdnUrl = isDebug ? '' :'http://qcdn.letwx.com/app/redbagrain-build/';
	gameid = getUrlParam().uid != undefined?getUrlParam().uid : 1;
	gp = getUrlParam().gp != undefined?getUrlParam().gp : 'NI_46IZOhizrGiGtRmKx2_YAOxJz2gJyPOGv-Alj9og';
	return {
		gameid: gameid,
		uid: gameid,
		gp: gp,
...
function __uri(str){
	return (config.baseCDNUrl + 'redbagrain-build/../' + str);
}
