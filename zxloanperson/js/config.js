var config = (function () {
    ...
    var baseUrl = isDebug ? '' : 'http://zx.letwx.com/app/zxloanperson-build/';
    var htmlUrl = isDebug ? '' : 'http://zx.letwx.com/app/zxloanperson-build/';
    var cdnUrl = isDebug ? '' : 'http://zxcdn.letwx.com/app/zxloanperson-build/';
...
function goToNextPage(page){
    setTimeout(function(){
        window.location.href = config.htmlUrl + page;
    }, 200);
}
...
function __uri(str) {
    return (config.baseCDNUrl + 'zxloanperson-build/../' + str);
}
