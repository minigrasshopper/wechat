var config = (function () {
    ...
    var baseUrl = isDebug ? '' : 'http://zx.letwx.com/app/zxloanorg-build/';
    var htmlUrl = isDebug ? '' : 'http://zx.letwx.com/app/zxloanorg-build/';
    var cdnUrl = isDebug ? '' : 'http://zxcdn.letwx.com/app/zxloanorg-build/';
...
function __uri(str) {
    return (config.baseCDNUrl + 'zxloanorg-build/../' + str);
}
