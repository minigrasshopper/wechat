var config = (function() {
	...
	var baseUrl = isDebug ? '' :'http://q.letwx.com/app/nianbeast-build/';
	var htmlUrl = isDebug ? '' :'http://q.letwx.com/app/nianbeast-build/';
	var cdnUrl = isDebug ? '' :'http://qcdn.letwx.com/app/nianbeast-build/';
	gameid = getUrlParam().uid != undefined?getUrlParam().uid:1;
	gp = getUrlParam().gp != undefined?getUrlParam().gp:'7Yu3aK9wzjRWC3gqNporqMXro2CTS--AOntk7ryFMfY';
	return {
		gameid: gameid,
		uid:gameid,
		gp:gp,
...
function __uri(str){
	return (config.baseCDNUrl + 'nianbeast-build/../' + str);
}
